    ...
    <div className="w-full lg:h-screen lg:overflow-hidden overflow-x-hidden relative">
      <div className="w-full h-full flex flex-col items-center">
        ...
        <div className="w-full h-[85%] flex flex-col">
          <div className="w-full  h-[10%] p-3 flex justify-center lg:justify-end">
            <div className="w-4/5 sm:w-2/4 lg:w-1/5 relative">
              <FaSearch className="absolute right-1 top-2" size={22} />
              <Input type="search" placeholder="Search..." />
            </div>
          </div>
          <div className="w-full text-center h-[10%] p-3">
