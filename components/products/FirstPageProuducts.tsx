...
const FirstPageProuducts = () => {
  ...
  return   <div className="w-full p-3 flex flex-col sm:flex-row justify-evenly items-center lg:h-[60%]">
...
export default FirstPageProuducts;
